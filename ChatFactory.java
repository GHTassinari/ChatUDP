...
public class ChatFactory {
    ...
    public static Sender build(boolean isConnectionOriented, String serverName, int serverPort, int localPort, MessageContainer container) throws ChatException {
